...
CREATE INDEX idx_sales_metrics_vendor ON sales_metrics(vendor_id);
...
CREATE INDEX idx_vendor_metrics_vendor_date ON vendor_metrics(vendor_id, metric_date);
...
CREATE INDEX idx_product_metrics_product ON product_metrics(product_id, metric_date);
